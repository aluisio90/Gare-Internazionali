...
CREATE TABLE ATLETI(
  ID_A INT(2) NOT NULL UNIQUE,
  Nome_A VARCHAR(25) NOT NULL,
  Cognome_A VARCHAR(25) NOT NULL,
  Data_N DATE NOT NULL,
  Istituto VARCHAR(25),
  Nazionalità_A VARCHAR(25) NOT NULL,
  ID_Sq TINYINT,
...
CREATE TABLE GARE(
  ID_G INT(2) NOT NULL UNIQUE,
  Nome_G VARCHAR(25) NOT NULL,
  Tipologia VARCHAR(25),
  Punteggio_Max INT(2),
  ID_Se TINYINT NOT NULL,
